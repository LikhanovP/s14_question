...
public class ImagePickerActivity extends ActionBarActivity implements ActionBar.TabListener, View.OnClickListener {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                case 0:
                    return "СДЕЛАТЬ ФОТО";//getString(R.string.title_section1).toUpperCase(l);
                case 1:
                    return "ВЫБРАТЬ ФОТО";//getString(R.string.title_section2).toUpperCase(l);
            }
            return null;
        }
    }
