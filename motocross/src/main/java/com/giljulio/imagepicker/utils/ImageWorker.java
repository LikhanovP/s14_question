...
public abstract class ImageWorker {
    ...
    private class BitmapWorkerTask extends AsyncTask<Void, Void, BitmapDrawable> {
        ...
        protected BitmapDrawable doInBackground(Void... params) {
            ...
            // to this task and our "close early" flag is not set then try and fetch the bitmap from
            // the cache
            ...
            // bound back to this task and our "close early" flag is not set, then call the main
        ...
        protected void onPostExecute(BitmapDrawable value) {
            ...
            // if cancel was called on this task or the "close early" flag is set then we're done
